...
|  Post   | 할일카드 작성    |  `POST`  | /api/post/                 | { title: String<br/>conetent: String }    | { username: String<br/>title: String<br/>conetent: String<br/>createdAt: String }                              |                             |             |
|  Post   | 할일카드 단일 조회 |  `GET`   | /api/post/{postId}         |                                           | { username: String<br/>title: String<br/>conetent: String<br/>createdAt: String<br/>success: boolean }         | POST_NOT_EXIST_EXCEPTION    |             |
...
|  Post   | 할일카드 수정    |  `PUT`   | /api/post/{postId}         | { title: String<br/>conetent: String }    | { username: String<br/>title: String<br/>conetent: String<br/>createdAt: String }                              | POST_NOT_EXIST_EXCEPTION    |             |
