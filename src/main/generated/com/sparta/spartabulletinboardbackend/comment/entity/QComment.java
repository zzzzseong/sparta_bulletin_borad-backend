...
public class QComment extends EntityPathBase<Comment> {
    ...
    public final com.sparta.spartabulletinboardbackend.post.entity.QPost post;
    ...
    public QComment(Class<? extends Comment> type, PathMetadata metadata, PathInits inits) {
        ...
        this.post = inits.isInitialized("post") ? new com.sparta.spartabulletinboardbackend.post.entity.QPost(forProperty("post"), inits.get("post")) : null;
